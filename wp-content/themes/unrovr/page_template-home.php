			...
			<section class="card-layout">
				<div class="card-intro">
					<?php
						...
						{
							?>
								<h1 class="homepage-template-site-title"><?php echo esc_html($unrovr_site_title); ?></h1> <!-- .homepage-template-site-title -->
							<?php
						}
					?>
					<?php
						...
						{
							?>
								<p class="homepage-template-description"><?php echo esc_html($unrovr_home_description); ?></p> <!-- .homepage-template-description -->
							<?php
						}
					?>
					<?php
					...
					<div class="card-triggers">
						...
						<a id="card-open" class="button secondary" href="#card">
							<?php
								$unrovr_home_button_2_text = get_theme_mod('unrovr_setting_home_button_2_text', "");
								
								if (! empty($unrovr_home_button_2_text))
								{
									echo esc_html($unrovr_home_button_2_text);
								}
								else
								{
					...
					<div class="cover">
						...
						<div class="card-info">
							<?php
								...
								{
									?>
										<h2 class="homepage-template-site-title"><?php echo esc_html($unrovr_site_title); ?></h2> <!-- .homepage-template-site-title -->
									<?php
								}
							?>
							<?php
								...
								{
									?>
										<h3 class="homepage-template-site-tagline"><?php echo esc_html($unrovr_tagline); ?></h3> <!-- .homepage-template-site-tagline -->
									<?php
								}
							?>
							<div class="card-desc">
				...
				<a class="close-card" href="#"></a> <!-- .close-card -->
			</section> <!-- .card-layout -->
			
			<div class="card-footer">
				<h1>
					<a href="#card"><?php esc_html_e('go to top', 'unrovr'); ?></a>
				</h1>
			</div> <!-- .card-footer -->
		<?php
	endwhile;
